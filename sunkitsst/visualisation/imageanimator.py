...
class BaseFuncAnimator(object):
    ...
    * 'p': play/pause active slider
    ...
    slider_ranges: list
        list of n long numbers for slider values
    ...
    def _make_axes_grid(self):
        ...
        if self.num_buttons > 0:
            ...
            horiz = [xsize] + [pad_size, xsize]*(self.num_buttons-1) + \
                    [Size.Fraction(0.12, Size.AxesY(self.axes)), small_x]
            ...
            horiz = [Size.Fraction(0.8, Size.AxesX(self.axes))] + \
                    [Size.Fraction(0.12, Size.AxesX(self.axes))]*2
...
class ImageAnimator(BaseFuncAnimator):
    ...
    * 'p': play/pause active slider
    ...
    def __init__(self, data, image_axes=[-2,-1], axis_range=None, **kwargs):
        ...
        self.axis_range = self._parse_axis_range(axis_range, self.slider_axes, data)
    ...
    def _parse_axis_range(self, axis_range, slider_axes, data):
        """
